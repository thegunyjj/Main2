...
public class CancelBind {
    ...
    public void cancel(String classId , final OnCancelListener listener){
        ...
        client.post(context, context.getString(R.string.tool_api_link)+"cancelBind",params,new AsyncHttpResponseHandler() {
            @Override
